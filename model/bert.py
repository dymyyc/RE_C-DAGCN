...
class BertSelfAttention(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask):
        ...
        attention_scores = torch.matmul(query_layer.float(), key_layer.float())
...
class BertPreTrainedModel(nn.Module):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path, state_dict=None, config=None, cache_dir=None,
...
class BertForSequenceClassification(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, labels=None, e1_mask=None, e2_mask=None, checkpoint_activations=False):
